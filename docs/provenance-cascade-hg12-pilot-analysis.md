# H-G.1.2 Offline Pilot Analysis

This evaluator-only analysis is bound to the completed H-G.1.2 Pilot through the
...
created. H-G.1.1, H-G.1, and H-D.2.1, WVS, `002`, `003`, and calibration materials are excluded
from this analysis.
