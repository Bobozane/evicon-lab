"""Bounded real-model pilot runner for the repaired factorized protocol v2.
...
from .conformity_source_behavior_factorized_protocol_v2 import (
...
DEFAULT_CONFIG: Final[str] = (
    ...
    "conformity_source_behavior_factorization_pilot.v2.toml"
)
DEFAULT_OUTPUT_ROOT: Final[str] = (
    "outputs/conformity-source-behavior-factorization-pilot-v2"
)
DEFAULT_RUNNER: Final[str] = "src/evicon/conformity_source_behavior_factorization_runner_v2.py"
SAFE_AUDIT_NAME: Final[str] = "safe_case_audits.jsonl"
RECEIPT_NAME: Final[str] = "pilot_receipt.json"
RUNNER_VERSION: Final[str] = "conformity_source_behavior_factorization_runner.v2"
RECEIPT_VERSION: Final[str] = "conformity_source_behavior_factorization_receipt.v2"
...
class FactorizationPilotConfig(BaseModel):
    ...
    pilot_id: Literal["evicon-conformity-source-behavior-factorization-pilot-v2"]
    pilot_version: Literal["conformity_source_behavior_factorization_pilot.v2"]
    runner_version: Literal["conformity_source_behavior_factorization_runner.v2"]
    ...
    protocol_path: Literal["src/evicon/conformity_source_behavior_factorized_protocol_v2.py"]
    protocol_sha256: str = Field(pattern=r"^[0-9a-f]{64}$")
    protocol_version: Literal["conformity_source_behavior_factorized_protocol.v2"]
    template_version: Literal["conformity_source_behavior_factorized_turn.v2"]
...
class PilotSchemaContract(BaseModel):
    ...
    template_version: Literal["conformity_source_behavior_factorized_turn.v2"] = TEMPLATE_VERSION
...
class FactorizationPilotReceipt(BaseModel):
    ...
    receipt_version: Literal["conformity_source_behavior_factorization_receipt.v2"]
    runner_version: Literal["conformity_source_behavior_factorization_runner.v2"]
    ...
    *,
    ...
    try:
        ...
        for case in cases:
            ...
            # A transport failure has no response metadata. Clear the prior
            # case so a bounded failure summary cannot report stale values.
            last_response = None
            last_parser_valid = None
            parser_error_category = None
