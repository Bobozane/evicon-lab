...
HG232_PROTOCOL_VERSION: Final[str] = "provenance_cascade_agent_protocol.hg2_3_2_truncation.v1"
HG232_TEMPLATE_VERSION: Final[str] = "cascade_agent_turn.hg2_3_2_truncation.v1"
HG232_SCHEMA_NAME: Final[str] = "cascade_agent_epistemic_adoption_sharing_v1_provider_subset_2048"
HG232_RESPONSE_JSON_SCHEMA: Final[dict[str, Any]] = {
    "type": "object",
...
def render_hg232_turn(context: HG2PromptContext) -> LLMRequest:
    base = render_hg23_turn(context)
    digest = hashlib.sha256(f"{HG232_PROTOCOL_VERSION}|{base.request_id}".encode("utf-8")).hexdigest()[:24]
    return base.model_copy(update={
        "request_id": f"hg232-{digest}",
        "metadata": {
            **base.metadata,
            "transport_protocol_version": HG232_PROTOCOL_VERSION,
            "transport_schema_name": HG232_SCHEMA_NAME,
            "provider_subset_schema": True,
        },
    })


class HG232Runtime(HG23Runtime):
    def render_request(self, context: HG2PromptContext) -> LLMRequest:
        return render_hg232_turn(context)


__all__ = [
    "HG232_PROTOCOL_VERSION", "HG232_RESPONSE_JSON_SCHEMA", "HG232_SCHEMA_NAME",
    "HG232_TEMPLATE_VERSION", "HG232Runtime", "HG23AgentResponse",
    "parse_hg23_response", "render_hg232_turn",
]
