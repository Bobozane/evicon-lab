...
from .conformity_source_relation_comprehension_calibration_v1 import (
    ...
    PROTOCOL_VERSION as CANONICAL_PROTOCOL_VERSION,
...
from .conformity_source_relation_comprehension_compatibility_provider_subset_short_name_v4 import (
    DEFAULT_RECEIPT as V4_COMPATIBILITY_RECEIPT,
    CompatibilityReceiptV4,
    load_receipt_v4,
)
from .conformity_source_relation_comprehension_provider_subset_short_name_v4_approval import (
    DEFAULT_APPROVAL as DEFAULT_V4_COMPATIBILITY_APPROVAL,
    DEFAULT_CONFIG as DEFAULT_V4_COMPATIBILITY_CONFIG,
    DEFAULT_MODULE as DEFAULT_V4_COMPATIBILITY_MODULE,
    PROVIDER_SCHEMA_MODULE,
    SHORT_PROVIDER_SCHEMA_NAME,
    load_compatibility_approval as load_v4_compatibility_approval,
    load_compatibility_config as load_v4_compatibility_config,
)
...
DEFAULT_CONFIG: Final[str] = (
    ...
    "conformity_source_relation_comprehension_qualification_provider_subset_short_name.v2.toml"
)
DEFAULT_APPROVAL: Final[str] = (
    "configs/provenance_cascade/identification/"
    "conformity_source_relation_comprehension_qualification_provider_subset_short_name_approval.v2.toml"
)
DEFAULT_RUNNER: Final[str] = (
    "src/evicon/conformity_source_relation_comprehension_qualification_provider_subset_short_name_v2.py"
)
DEFAULT_OUTPUT_ROOT: Final[str] = (
    "outputs/conformity-source-relation-comprehension-qualification-provider-subset-short-name-v2"
)
DEFAULT_ATTEMPT_CLAIM: Final[str] = (
    "outputs/study-locks/conformity_source_relation_comprehension_qualification_provider_subset_short_name.v2.claim"
)
SAFE_AUDIT_NAME: Final[str] = "safe_case_audits.jsonl"
ATTEMPT_RECEIPT_NAME: Final[str] = "qualification_attempt_receipt.json"
RUNNER_VERSION: Final[str] = "conformity_source_relation_comprehension_qualification_provider_subset_short_name_runner.v2"
RECEIPT_VERSION: Final[str] = "conformity_source_relation_comprehension_qualification_provider_subset_short_name_receipt.v2"
CANONICAL_SCHEMA_VERSION: Final[str] = "conformity_source_relation_comprehension_response.v1"
...
class SourceRelationQualificationConfig(BaseModel):
    ...
    qualification_id: Literal[
        "evicon-source-relation-comprehension-qualification-provider-subset-short-name-v2"
    ]
    qualification_version: Literal["conformity_source_relation_comprehension_qualification_provider_subset_short_name.v2"]
    runner_version: Literal[
        "conformity_source_relation_comprehension_qualification_provider_subset_short_name_runner.v2"
    ]
    ...
    safe_artifact_write_permitted_after_authorization: Literal[True]
    ...
    v4_compatibility_config_path: Literal[
        "configs/provenance_cascade/identification/"
        "conformity_source_relation_comprehension_compatibility_provider_subset_short_name.v4.toml"
    ]
    v4_compatibility_config_sha256: str = Field(pattern=r"^[0-9a-f]{64}$")
    v4_compatibility_approval_path: str = Field(min_length=1)
    v4_compatibility_approval_sha256: str = Field(pattern=r"^[0-9a-f]{64}$")
    v4_compatibility_module_path: Literal[
        "src/evicon/conformity_source_relation_comprehension_compatibility_provider_subset_short_name_v4.py"
    ]
    v4_compatibility_module_sha256: str = Field(pattern=r"^[0-9a-f]{64}$")
    compatibility_receipt_path: str = Field(min_length=1)
    compatibility_receipt_version: Literal[
        "conformity_source_relation_comprehension_compatibility_provider_subset_short_name_receipt.v4"
    ]
    ...
    calibration_protocol_version: Literal["conformity_source_relation_comprehension_calibration.v1"]
    template_version: Literal["conformity_source_relation_comprehension_turn.v1"]
    canonical_schema_name: Literal["conformity_source_relation_comprehension_response_v1"]
    ...
    provider_schema_module_path: Literal[
...
class SourceRelationQualificationApproval(BaseModel):
    ...
    approval_version: Literal[
        "conformity_source_relation_comprehension_qualification_provider_subset_short_name_approval.v2"
    ]
...
class QualificationSchemaContract(BaseModel):
    ...
    provider_schema_name: Literal[SHORT_PROVIDER_SCHEMA_NAME] = SHORT_PROVIDER_SCHEMA_NAME
    provider_schema_version: Literal[PROVIDER_SCHEMA_VERSION] = PROVIDER_SCHEMA_VERSION
    provider_schema_sha256: str = Field(
        default=PROVIDER_RESPONSE_SCHEMA_SHA256, pattern=r"^[0-9a-f]{64}$"
    )
    canonical_schema_name: Literal["conformity_source_relation_comprehension_response_v1"] = (
        CANONICAL_SCHEMA_NAME
    )
    canonical_schema_version: Literal["conformity_source_relation_comprehension_response.v1"] = (
        CANONICAL_SCHEMA_VERSION
    )
    canonical_schema_sha256: str = Field(
        default=CANONICAL_RESPONSE_SCHEMA_SHA256, pattern=r"^[0-9a-f]{64}$"
    )
    template_version: Literal["conformity_source_relation_comprehension_turn.v1"] = (
        TEMPLATE_VERSION
    )
...
class QualificationReceipt(BaseModel):
    ...
    receipt_version: Literal[
        "conformity_source_relation_comprehension_qualification_provider_subset_short_name_receipt.v2"
    ]
    runner_version: Literal[
        "conformity_source_relation_comprehension_qualification_provider_subset_short_name_runner.v2"
    ]
...
def load_qualification_config(
    ...
    try:
        ...
        v4_config = load_v4_compatibility_config(parsed.v4_compatibility_config_path)
        expected = {
            "calibration_config_sha256": _sha256_bytes(
                _resolve(parsed.calibration_config_path).read_bytes()
            ),
            "calibration_protocol_sha256": calibration.protocol_sha256,
            "calibration_protocol_version": CANONICAL_PROTOCOL_VERSION,
            "template_version": TEMPLATE_VERSION,
            "canonical_schema_name": CANONICAL_SCHEMA_NAME,
            "canonical_schema_sha256": CANONICAL_RESPONSE_SCHEMA_SHA256,
            "provider_schema_name": SHORT_PROVIDER_SCHEMA_NAME,
            "provider_schema_version": PROVIDER_SCHEMA_VERSION,
            "provider_schema_sha256": PROVIDER_RESPONSE_SCHEMA_SHA256,
            "provider_schema_module_path": PROVIDER_SCHEMA_MODULE,
            "provider_schema_module_sha256": sha256_file(PROVIDER_SCHEMA_MODULE),
            "v4_compatibility_config_path": DEFAULT_V4_COMPATIBILITY_CONFIG,
            "v4_compatibility_config_sha256": sha256_file(
                DEFAULT_V4_COMPATIBILITY_CONFIG
            ),
            "v4_compatibility_module_path": DEFAULT_V4_COMPATIBILITY_MODULE,
            "v4_compatibility_module_sha256": v4_config.compatibility_module_sha256,
        ...
        if {key: getattr(parsed, key) for key in expected} != expected:
            raise ValueError("static binding mismatch")
        if (
            _sha256_bytes(_resolve(parsed.v4_compatibility_approval_path).read_bytes())
            != parsed.v4_compatibility_approval_sha256
            or _sha256_bytes(_resolve(parsed.compatibility_receipt_path).read_bytes())
            != parsed.compatibility_receipt_sha256
        ):
            raise ValueError("parent artifact hash mismatch")
    except Exception as exc:
        raise SourceRelationQualificationError(
            "source_relation_qualification_config_binding_mismatch"
        ) from exc
...
def load_qualification_approval(
    ...
    *,
    ...
    expected = {
        ...
        "v4_compatibility_config_sha256": config.v4_compatibility_config_sha256,
        "v4_compatibility_approval_sha256": config.v4_compatibility_approval_sha256,
        "v4_compatibility_module_sha256": config.v4_compatibility_module_sha256,
...
class _FrozenBindings(BaseModel):
    ...
    compatibility_receipt_sha256: str = Field(pattern=r"^[0-9a-f]{64}$")
    v4_compatibility_approval_sha256: str = Field(pattern=r"^[0-9a-f]{64}$")
    compatibility_receipt: CompatibilityReceiptV4
...
def _freeze_bindings(
    *,
    ...
    try:
        if _resolve(compatibility_receipt_path) != _resolve(config.compatibility_receipt_path):
            raise SourceRelationQualificationError(
                "source_relation_qualification_compatibility_receipt_path_mismatch"
            )
        if _resolve(compatibility_approval_path) != _resolve(
            config.v4_compatibility_approval_path
        ):
            raise SourceRelationQualificationError(
                "source_relation_qualification_compatibility_approval_path_mismatch"
            )
        compatibility_approval = load_v4_compatibility_approval(
        ...
        compatibility_receipt = load_receipt_v4(
    ...
    if (
        compatibility_receipt.model != config.required_model
        or compatibility_receipt.schema_contract.schema_name
        != config.provider_schema_name
        or compatibility_receipt.schema_contract.schema_version
        != config.provider_schema_version
        or compatibility_receipt.schema_contract.schema_sha256
        != config.provider_schema_sha256
        or compatibility_receipt.execution_bindings.canonical_schema_sha256
        != config.canonical_schema_sha256
        or compatibility_receipt.execution_bindings.protocol_version
        != config.calibration_protocol_version
        or compatibility_receipt.execution_bindings.template_version
        != config.template_version
        or compatibility_receipt.execution_bindings.provider_schema_module_sha256
        != config.provider_schema_module_sha256
        or compatibility_receipt.execution_bindings.compatibility_config_sha256
        != config.v4_compatibility_config_sha256
        or compatibility_receipt.execution_bindings.compatibility_approval_sha256
        != config.v4_compatibility_approval_sha256
        or compatibility_receipt.execution_bindings.compatibility_module_sha256
        != config.v4_compatibility_module_sha256
        or compatibility_receipt.generation_parameters.max_tokens != config.max_tokens
        or compatibility_receipt.generation_parameters.temperature != config.temperature
        or compatibility_receipt.generation_parameters.seed != config.seed
        or compatibility_receipt.generation_parameters.max_retries != config.max_retries
        or compatibility_receipt.generation_parameters.timeout_seconds
        != config.timeout_seconds
        or compatibility_receipt.generation_parameters.reasoning_effort
        != config.reasoning_effort
    ):
        raise SourceRelationQualificationError(
            "source_relation_qualification_compatibility_binding_mismatch"
        )
    return _FrozenBindings(
        ...
        v4_compatibility_approval_sha256=_sha256_bytes(
            _resolve(compatibility_approval_path).read_bytes()
        ),
    ...
    *,
    ...
    try:
        ...
        receipt = QualificationReceipt(
            ...
            v4_compatibility_config_sha256=(
                bindings.config.v4_compatibility_config_sha256
            ),
            v4_compatibility_approval_sha256=(
                bindings.v4_compatibility_approval_sha256
            ),
            v4_compatibility_module_sha256=(
                bindings.config.v4_compatibility_module_sha256
            ),
            provider_schema_module_sha256=(
                bindings.config.provider_schema_module_sha256
            ),
...
def load_qualification_receipt(
    ...
    *,
    ...
    compatibility_receipt_path: str | Path = V4_COMPATIBILITY_RECEIPT,
    compatibility_approval_path: str | Path = DEFAULT_V4_COMPATIBILITY_APPROVAL,
    ...
    if (
        ...
        or receipt.v4_compatibility_config_sha256
        != bindings.config.v4_compatibility_config_sha256
        or receipt.v4_compatibility_approval_sha256
        != bindings.v4_compatibility_approval_sha256
        or receipt.v4_compatibility_module_sha256
        != bindings.config.v4_compatibility_module_sha256
        or receipt.provider_schema_module_sha256
        != bindings.config.provider_schema_module_sha256
        or receipt.compatibility_receipt_sha256
        != bindings.compatibility_receipt_sha256
        or receipt.schema_contract.provider_schema_sha256
        != bindings.config.provider_schema_sha256
        or receipt.schema_contract.canonical_schema_sha256
        != bindings.config.canonical_schema_sha256
    ):
        raise SourceRelationQualificationError(
            "source_relation_qualification_receipt_binding_mismatch"
        )
...
def execute_qualification_v2(
    *,
    ...
    return _execute_qualification_v2(
        ...
        compatibility_receipt_path=V4_COMPATIBILITY_RECEIPT,
        compatibility_approval_path=DEFAULT_V4_COMPATIBILITY_APPROVAL,
        output_root=DEFAULT_OUTPUT_ROOT,
        attempt_claim_path=DEFAULT_ATTEMPT_CLAIM,
    )
